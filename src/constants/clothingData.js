...
export const FOLDING_INSTRUCTIONS = {
  ...
  [CLOTHING_CATEGORIES.SOCKS]: 'Сложите парой: один носок внутрь другого, не растягивая резинку',
  [CLOTHING_CATEGORIES.WOOL]: 'Сложите плоско, не вешайте — шерсть тянется на плечиках',
...
export const WASHING_INSTRUCTIONS = {
  ...
  [CLOTHING_CATEGORIES.SOCKS]: '40°C, обычный режим. Не использовать отбеливатель.',
  [CLOTHING_CATEGORIES.WOOL]: '30°C, режим «шерсть». Сушить горизонтально, не отжимать.',
