...
export const getDefaultInstruction = (category) => {
  const map = {
    ...
    носки: 'Сложите парой: один носок внутрь другого, не растягивая резинку',
    шерсть: 'Сложите плоско, не вешайте — шерсть тянется на плечиках',
...
export const getDefaultWashing = (category) => {
  const map = {
    ...
    носки: '40°C, обычный режим. Не использовать отбеливатель.',
    шерсть: '30°C, режим «шерсть». Сушить горизонтально, не отжимать.',
